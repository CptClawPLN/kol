...
MainLoop:
	...
	isTimed: function (skillId) {
		return [15, 25, 27, 51, 56, 57, 59, 62, 64, 121, 225, 223, 228, 229, 234, 244, 247, 249, 250, 256, 268, 275, 277, 279].indexOf(skillId) > -1;
	},
...
var Misc = {
	...
	itemLogger: function (action, unit, text) {
		...
		var desc,
			...
			mm = (date.getMonth() + 1),
			dd = date.getDate(),
			dateString = "[" + yyyy + (mm < 10 ? "0" + mm : mm) + (dd < 10 ? "0" + dd : dd) + " - " + (h < 10 ? "0" + h : h) + ":" + (m < 10 ? "0" + m : m) + ":" + (s < 10 ? "0" + s : s) + "]";
